...
|--------|---------|-------------|------|
| [feature-creator](plugins/feature-creator/) | 0.8.0 | Feature and bug-fix pipeline — GitHub issues to implementation plans to PRs (handles `feature - ready for claude` and `bug - ready for claude`) | [README](plugins/feature-creator/README.md) |
